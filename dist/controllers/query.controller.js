...
const findLatestComments = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const comments = yield queryService.findLatestComments(req.params.id, req.query.skip, req.query.limit);
...
const searchByUsername = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const users = yield queryService.searchByUsername(req.query.search);
